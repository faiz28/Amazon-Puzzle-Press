...
class WordSearch():
    ...
    def __init__(self, searchWords, maxX = 20, maxY = 20):
        ...
        testWords = ["announcement,continuation,intelligence,presidential,manufacturer,neighborhood,manufacturer,conglomerate,constituency,compensation,prescription,registration,interference,relationship,introduction,discriminate,conversation,civilization,architecture,spokesperson,presentation,satisfaction,satisfaction,transmission,transmission,acquaintance,introduction,presidential,intelligence"]
...
if __name__ == '__main__':
    words = ("announcement,continuation,intelligence,presidential,manufacturer,neighborhood,manufacturer,conglomerate,constituency,compensation,prescription,registration,interference,relationship,introduction,discriminate,conversation,civilization,architecture,spokesperson,presentation,satisfaction,satisfaction,transmission,transmission,acquaintance,introduction,presidential,intelligence")
